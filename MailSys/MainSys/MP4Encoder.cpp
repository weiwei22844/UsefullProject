...
bool MP4Encoder::WriteH264File(const char* pFile264, const char* pFileMp4, int nWidth, int nHeight, int nFrameRate)
{
    ...
    MP4FileHandle hMp4File = CreateMP4File(pFileMp4,nWidth,nHeight,90000,nFrameRate);
