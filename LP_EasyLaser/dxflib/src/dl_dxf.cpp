...
//        }
        ...
        } else if (groupValue=="TABLES"){                       // added by ZWW
            currentObjectType = DL_SEC_TABLES;
        } else if (groupValue == "TABLE"){
            currentObjectType = DL_TABLE;
        } else if (groupValue == "LTYPE"){
            currentObjectType = DL_LINETYPE;
        } else if (groupValue == "HEADER"){
            currentObjectType = DL_SEC_HEADER;
        } else {
            currentObjectType = DL_UNKNOWN;
        }
...
void DL_Dxf::addLineType(DL_CreationInterface* creationInterface) {
    ...
    DL_LineTypeData d(name, getIntValue(70, 0));
